...
impl QuantumVRF {
    ...
    pub fn generate(
        ...
        debug!("Generated SPHINCS+ signature in {:?}", signature_start.elapsed());
    ...
    pub fn verify(
        ...
        debug!("SPHINCS+ signature verified in {:?}", verify_start.elapsed());
...
mod tests {
    ...
    fn test_vrf_generation_and_verification() -> Result<(), Box<dyn Error>> {
        ...
        assert!(!valid, "VRF verification should fail with modified quantum key");
